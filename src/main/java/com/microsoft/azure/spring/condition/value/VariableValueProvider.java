...
public class VariableValueProvider<V> implements ValueProvider<V> {
    ...
    private Object getValueFromProps(Object value) throws Exception {
        ...
        for (int i = 0; i < props.length; i++) {
            ...
            if (propField == null) {
                ...
                throw new Exception("UNABLE_TO_FIND_PROPERTY_FOR_CONDITION");
            }
            try {
                ...
                String pp = generatePropPath(i);
                throw new Exception("UNABLE_TO_GET_PROPERTY_FOR_CONDITION");
            }
        }
        return propValue;
    }
