...
public class LocalVarMetadata implements Comparable<LocalVarMetadata> {
    ...
    public LocalVarMetadata(int startPc, int idx, String name, String originalName, String typeSignature) {
        this.startPc = startPc;
        this.idx = idx;
        this.name = name;
